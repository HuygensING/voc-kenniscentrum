...
# Where you want the indexer to start - vanaf indexer.cgi (full path; end with /)
$INDEXER_START = '/'; # re-index

# The base url of your site being indexed
# Be sure it corresponds to the $INDEXER_START directory (end with /)
$BASE_URL = 'http://www.voc-kenniscentrum.nl/';

# The url where ksearch.cgi is located
$SEARCH_URL = "http://www.voc-kenniscentrum.nl/cgi-bin/ksearch/ksearch.cgi";

# The full-path of the ksearch directory (end with /)
$KSEARCH_DIR = '/var/www/voc-kenniscentrum/cgi-bin/ksearch/'; # re-index
...
@VALID_REFERERS = ("http://www.voc-kenniscentrum.nl/");

$INDEXER_URL = "http://www.voc-kenniscentrum.nl/cgi-bin/ksearch/indexer.cgi";

$PASSWORD = "paulus88";		# required for indexer.cgi
#####################################################################
...
$IGNORE_COMMON_TERMS = 90; # re-index
...
$LOG_SEARCH = '../ksearch/search_log.txt';
...
$ALT_TEXT = 0;	# re-index if changing from 0; # edit-help-template
...
$TITLE_WEIGHT = 3;		# a value 1 or above
